  ...
  if (!priceDataPoints || priceDataPoints.length < 7) {
    return (
      <div className="bg-white shadow rounded-lg p-6">
        <h2 className="text-lg font-medium text-gray-900 mb-4">Price Prediction</h2>
    ...
    <div className="bg-white shadow rounded-lg p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="border border-gray-200 rounded-lg p-4">
          <p className="text-sm text-gray-500 mb-1">24 Hour Prediction</p>
        ...
        {/* 7d Prediction */}
        <div className="border border-gray-200 rounded-lg p-4">
          <p className="text-sm text-gray-500 mb-1">7 Day Prediction</p>
          <p className="text-2xl font-bold text-gray-900">
        ...
        {/* 30d Prediction */}
        <div className="border border-gray-200 rounded-lg p-4">
          <p className="text-sm text-gray-500 mb-1">30 Day Prediction</p>
          <p className="text-2xl font-bold text-gray-900">
      ...
      <div className="mb-6 p-4 bg-gray-50 rounded-lg">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <span className="text-sm font-medium text-gray-700">Probability of Price Increase</span>
          </div>
          <span className={`text-2xl font-bold ${increaseProb >= 50 ? 'text-green-600' : 'text-red-600'}`}>
            {increaseProb}%
          </span>
        </div>
        <div className="mt-2 w-full bg-gray-200 rounded-full h-2">
          <div
            className={`h-2 rounded-full ${increaseProb >= 50 ? 'bg-green-600' : 'bg-red-600'}`}
